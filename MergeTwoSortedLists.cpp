 ...
 *    - Introduces the idea of *stream merging*, useful in many data structures and file I/O problems.
 *
 ...
 *    - Great example of a **"builder pointer" pattern**, used when constructing or extending lists.
 *
 * 6. **Final Attachment Shortcut**
 *    - Once one list ends, attach the other directly: `tail->next = list1 ? list1 : list2;`
 *    - Demonstrates *early termination optimization*: no need for more iteration once one side is empty.
 ...
 *    - Trains recognizing iterative ↔ recursive equivalence in linked structures.
 *
 ...
 * - Demonstrates elegance: **simple pointer manipulation can achieve complex structural transformations.**
 *
